...
4. Default Payout rate: ${payoutRate}

Return ONLY a valid JSON object with "zones" array containing ALL 34 columns (same as Team App format):
{
  "zones": [
    {
      "Name of zone": "example_zone_name",
      "Zone URL": "${input.mediaName}",
      "Allowed domain list": "",
      "Inventory Type": "Desktop",
      "Type of zone": "スタンダードバナー",
