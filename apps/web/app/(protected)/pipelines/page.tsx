...
import type { Pipeline, PipelineGroup } from '@query-stream-ai/types/pipeline'
import {
  POC_NAMES,
  CLASSIFICATION_TYPES,
  PRODUCT_TYPES,
  PIPELINE_STAGES,
} from '@query-stream-ai/types/pipeline'
import { GroupTabs } from '@/components/pipelines/GroupTabs'
import { PipelineKanban } from '@/components/pipelines/PipelineKanban'
import {
...
} from '@/components/pipelines/skeletons'
import { PipelineDetailDrawer } from '@/components/pipelines/PipelineDetailDrawer'
import { SalesCycleCard } from '@/components/pipelines/SalesCycleCard'
import { NewPipelinesCard } from '@/components/pipelines/NewPipelinesCard'
import { SimpleDataTable } from '@/components/pipelines/SimpleDataTable'
import { RevenueForecastTable } from '@/components/pipelines/RevenueForecastTable'
import { SalesCycleBreakdownCard } from '@/components/pipelines/SalesCycleBreakdownCard'
import { SConfirmationTable } from '@/components/pipelines/SConfirmationTable'
import { MissingPidMidTable } from '@/components/pipelines/MissingPidMidTable'
import { PipelineImpactTable } from '@/components/pipelines/PipelineImpactTable'
import { PipelineReportCard } from '@/components/pipelines/PipelineReportCard'
import { FilterPanel } from '@/components/pipelines/FilterPanel'
