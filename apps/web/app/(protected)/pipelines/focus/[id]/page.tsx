...
import { EditFocusModal } from '@/components/pipelines/EditFocusModal'
import { AddPipelinesModal } from '@/components/pipelines/AddPipelinesModal'
import { PipelineDetailDrawer } from '@/components/pipelines/PipelineDetailDrawer'
import FocusSuggestionsTable from '@/components/pipelines/FocusSuggestionsTable'
import { MetricCard } from '@/components/performance-tracker/MetricCard'
import { FocusDetailSkeleton } from '@/components/pipelines/skeletons'
import { PipelinePageLayout } from '@/components/pipelines/PipelinePageLayout'
import { useAuth } from '@/app/contexts/AuthContext'
import type { Focus, FocusSuggestion } from '@query-stream-ai/types/focus'
import type { Pipeline } from '@query-stream-ai/types/pipeline'
