...
import { Challenge, ChallengeStatus } from '@query-stream-ai/types/challenge';
import { Card, CardContent, CardHeader, CardTitle } from '@query-stream-ai/ui/card';
import { Button } from '@query-stream-ai/ui/button';
import { Badge } from '@query-stream-ai/ui/badge';
import { Input } from '@query-stream-ai/ui/input';
import { Label } from '@query-stream-ai/ui/label';
import { Textarea } from '@query-stream-ai/ui/textarea';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogHeader,
  DialogTitle,
} from '@query-stream-ai/ui/dialog';
import {
  Table,
  TableBody,
  TableCell,
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from '@query-stream-ai/ui/select';
import {
  Plus,
  Pencil,
  Trash2,
